...
public class GraphMLExporterTest {
	...
	public void testRelationAnnotation() throws UIMAException
	{
		...
		//GraphML Export
		AnalysisEngineDescription graphML = createEngineDescription(GraphMLExporter.class);
		AnalysisEngine graphmlEngine = createEngine(graphML);
		graphmlEngine.process(jcas);
